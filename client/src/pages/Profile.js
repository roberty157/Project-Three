        ...
        <Row>
          <Col className="mt-1" md={5} sm={12}>
            ...
            {data.me.homeCity ? (
              <Card fluid>
                ...
                <Card.Content>
                  <Card.Header>
                    {data.me.homeCity.name.split(",")[0]}
                  </Card.Header>
                  <Card.Meta>{data.me.homeCity.name}</Card.Meta>
                  <Card.Description>
                    <li>
                      Population:{" "}
                      {numbersWithCommas(data.me.homeCity.population)}
                    </li>
                  </Card.Description>
                </Card.Content>
              </Card>
          ...
          <Col sm={12} md={7} className="mt-3">
            <Container className="data">
              {" "}
              <h2> Discover Your Best Place to Move </h2>{" "}
            </Container>
                    ...
                    {userData.savedCities.map((city) => {
                      return (
                        ...
                        >
                          <Nav.Item>
                            <Nav.Link
                              className="p-2 savedChart"
                              eventKey={city.cityId}
                            >
                              {" "}
                              {city.name}
                            </Nav.Link>
